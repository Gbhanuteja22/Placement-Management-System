...
const DemoSignInPage = React.lazy(() => import('./pages/DemoSignInPage'));
const DemoSignUpPage = React.lazy(() => import('./pages/DemoSignUpPage'));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="bg-yellow-400 text-yellow-900 text-center py-2 px-4 text-sm font-medium">
        ...
        <a href="https://dashboard.clerk.com/" target="_blank" className="underline ml-1">
          Add Clerk credentials for full authentication
        </a>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              {!isSignedIn ? (
                <div className="flex items-center space-x-2">
                  <nav className="hidden lg:flex space-x-6 mr-4">
                  ...
                  <button
                    ...
                    className="px-3 py-2 text-gray-700 hover:text-blue-600 border border-gray-300 rounded-lg text-sm font-medium hover:border-blue-600 transition-all duration-200"
                  >
                    Login
                  </button>
                  <button
                    onClick={() => navigate('/sign-up')}
                    className="px-3 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-all duration-200 shadow-sm hover:shadow-md"
                  >
                    Sign Up
                  </button>
                  <button
                    onClick={() => navigate('/sign-up')}
                    className="hidden sm:block px-3 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg text-sm font-medium hover:from-purple-700 hover:to-blue-700 transition-all duration-200 shadow-sm hover:shadow-md"
                  >
                    Register
                  </button>
                </div>
...
function DemoStudentDashboard() {
  ...
  // Use the same dashboard but with demo auth
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Demo Mode Banner */}
      <div className="bg-yellow-400 text-yellow-900 text-center py-2 px-4 text-sm font-medium">
        🎯 Demo Mode Active - Sign out to return to homepage
      </div>
      
      <StudentDashboard />
      
      {/* Override the user button with demo sign out */}
      ...
      <div className="min-h-screen">
        ...
        >
          <Routes>
            ...
            <Route path="/sign-in" element={<DemoSignInPage />} />
            <Route path="/sign-up" element={<DemoSignUpPage />} />
